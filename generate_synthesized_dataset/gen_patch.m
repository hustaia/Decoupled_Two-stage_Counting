function [coordinate, radius] = gen_patch(max_num, min_num, dataset)
...
switch dataset
    case 'A'
        a = csvread('A_train_patchnum.csv', 1, 0);
    case 'B'
        a = csvread('B_train_patchnum.csv', 1, 0);
    case 'Q'
        a = csvread('Q_train_patchnum.csv', 1, 0);
end
a = 1 - a / sum(a);
a = a / sum(a);
a = cumsum(a);
